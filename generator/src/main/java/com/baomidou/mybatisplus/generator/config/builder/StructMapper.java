 ...
 * @since 3.5.0
 */
public class StructMapper implements ITemplate {
     ...
     * @since 3.5.0
     */
    private ConverterFileName converterMapperFileName = (entityName -> entityName + ConstVal.STRUCT_MAPPER);
    ...
    public static class Builder extends BaseBuilder {
        ...
        private final StructMapper structMapper = new StructMapper();
        ...
        public Builder superClass(@NotNull String superClass) {
            this.structMapper.superClass = superClass;
            return this;
        }
        ...
        public Builder enableMapperAnnotation() {
            this.structMapper.mapperAnnotation = true;
            return this;
        }
        ...
        public Builder enableBaseResultMap() {
            this.structMapper.baseResultMap = true;
            return this;
        }
        ...
        public Builder enableBaseColumnList() {
            this.structMapper.baseColumnList = true;
            return this;
        }
        ...
        public Builder convertMapperFileName(@NotNull ConverterFileName converter) {
            this.structMapper.converterMapperFileName = converter;
            return this;
        }
        ...
        public Builder convertXmlFileName(@NotNull ConverterFileName converter) {
            this.structMapper.converterXmlFileName = converter;
            return this;
        }
        ...
        public Builder fileOverride() {
            this.structMapper.fileOverride = true;
            return this;
        }

        @NotNull
        public StructMapper get() {
            return this.structMapper;
        }
    }
}
