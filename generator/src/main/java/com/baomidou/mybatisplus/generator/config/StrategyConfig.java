...
public class StrategyConfig {
    ...
    private final StructMapper.Builder mapstructBuilder = new StructMapper.Builder(this);
    ...
    @NotNull
    public StructMapper.Builder mapstructBuilder() {
        return mapstructBuilder;
    }

    @NotNull
    public StructMapper structMapper() {
        if (structMapper == null) {
            this.structMapper = mapstructBuilder.get();
        }
        return structMapper;
    }
