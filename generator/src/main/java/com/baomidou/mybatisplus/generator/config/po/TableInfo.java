...
public class TableInfo {
    ...
    private String structMapperName;
    ...
    public void processTable() {
        ...
        this.structMapperName = strategyConfig.structMapper().getConverterMapperFileName().convert(entityName);
    ...
    public String getStructMapperName() {
        return structMapperName;
    }
